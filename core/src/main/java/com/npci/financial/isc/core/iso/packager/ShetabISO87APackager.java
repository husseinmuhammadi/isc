package com.npci.financial.isc.core.iso.packager;
...
public class ShetabISO87APackager extends ISO87APackager {
    protected ISOFieldPackager fld[] = {
    	    ...
    	    /*028*/ new IFA_AMOUNT(12, "AMOUNT, TRANSACTION FEE"),
    	    ...
    	    /*043*/ new IFB_BINARY(40, "CARD ACCEPTOR NAME/LOCATION"),
    	    ...
    	    /*096*/ new IFA_BINARY(8, "MESSAGE SECURITY CODE"),            //Changed according to Shetab
