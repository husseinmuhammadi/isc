package com.npci.financial.isc.model.to.isc.test;
...
import com.npci.financial.isc.model.converter.isc.product.ProductCodeConverter;
import com.npci.financial.isc.model.converter.isc.test.TestConditionTypeConverter;
import com.npci.financial.isc.model.converter.isc.transaction.InteractionPointConverter;
import com.npci.financial.isc.model.converter.isc.transaction.ProcessingCodeConverter;
import com.npci.financial.isc.model.converter.isc.transaction.TransactionModeConverter;
...
public class TestCase extends EntityBase {
    ...
    @Column(name = "PRIMARY_ACCOUNT_NUMBER", nullable = true, length = 19)
    ...
    public String getFinancialServiceProvider() {
        return financialServiceProvider;
    }

    public void setFinancialServiceProvider(String financialServiceProvider) {
